...
local function apply_base16_theme(theme, use_256_colorspace)
	...
	highlight("MatchParen",    nil, theme.base02, nil, cterm02,  "bold", nil)
	...
	highlight("Operator",     theme.base09, nil, cterm09, nil, "none", nil)
	...
	highlight("Statement",    theme.base0E, nil, cterm0E, nil, nil, nil)
